...
ActiveRecord::Schema[8.0].define(version: 2025_03_20_083022) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "phone_call", default: 0, null: false
    t.integer "phone_call_status", default: 0, null: false
    t.text "message"
    t.text "notation"
    t.decimal "order_discount", precision: 8, scale: 2, default: "0.0", null: false
